...
echo
echo "--- start zygote clean + lazy preload ---"
...
nohup env -i \
  ...
  "$WRAP" \
    ...
    /system/bin/app_process64 \
      ...
      --abi-list=arm64-v8a \
      --enable-lazy-preload \
  >"$LOGDIR/zygote64.clean-lazy.log" 2>&1 &
...
echo
echo "--- log ---"
tail -n 260 "$LOGDIR/zygote64.clean-lazy.log"
